%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   HOME EXAM PART B - Telerobotics and applied sensor fusion, 7.5hp
...
while(~strcmp(str,'exit'))
    ...
    % Prompt the user for a telecommand
    prompt = 'Enter telecommand: ';
    str = input(prompt,'s');
    
    % If it is QuadDrive, drive along a wall
    if (strcmp(str,'QuadDrive'))
        ...
        while (distanceDriven < (abs(x)-stopDistance) && epoch < maxEpochs)
            ...
            %gamma = ObstacleAvoidance(Vehicle, wall, gamma);
